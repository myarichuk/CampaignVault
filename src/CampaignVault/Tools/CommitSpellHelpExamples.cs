...
**After any spell:** commit `status` separately for concentration, charm, etc. Engine does not track spell slots.
""";
...
{ "$type": "character_create", "characterId": "chars/gish", "name": "Aldric", "isPc": true, "keepAlive": true,

...
- **Filter NPC knowledge through Psychology.Memories.** Only narrate what they could plausibly know (Witnessed/Heard/Told/Experienced/Trauma/Conditioned). NPCs are not telepathic—they cannot react to PC thoughts or meta-prompts. Same for `gmOnly` notes — backstage until discovered.

...
public class SystemStatsBootstrapHarnessTests : IClassFixture<RavenDBFixture>
{
    ...
    [
        ...
        new CharacterCreateHandler(new CampaignVault.Data.CampaignDocumentKeys(), BootstrapTestHelper.CreateOrchestrator()),
        ...
        new LevelUpChangeHandler(new CampaignVault.Data.CampaignDocumentKeys(), BootstrapTestHelper.CreateOrchestrator()),

...
public class SystemStatsBootstrapHarnessTests : IClassFixture<RavenDBFixture>
{
    ...
    [
        ...
        new CharacterCreateHandler(new CampaignVault.Data.CampaignDocumentKeys()),
        ...
        new CharacterUpdateHandler(new CampaignVault.Data.CampaignDocumentKeys()),
        new SystemStatsChangeHandler(new CampaignVault.Data.CampaignDocumentKeys()),

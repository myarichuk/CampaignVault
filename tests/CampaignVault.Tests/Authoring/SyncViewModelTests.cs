...
public class SyncViewModelTests : IDisposable
{
    ...
    public async Task PopulateActualDiffs_ModifiedLocally_WorksCorrectly()
    {
        ...
        var jsonContent = JsonSerializer.Serialize(character);
        var remoteItem = new EntityItem { Id = charId, Type = "character", Content = jsonContent };
    ...
    public async Task PopulateActualDiffs_ModifiedRemotely_WorksCorrectly()
    {
        ...
        var remoteSyncedItem = new EntityItem { Id = charId, Type = "character", Content = syncedJson };
        ...
        var remoteModifiedItem = new EntityItem { Id = charId, Type = "character", Content = modifiedJson };
    ...
    public async Task PopulateActualDiffs_Conflict_WorksCorrectly()
    {
        ...
        var remoteModifiedItem = new EntityItem { Id = charId, Type = "character", Content = remoteModifiedJson };
